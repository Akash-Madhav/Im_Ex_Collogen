...
function ProductCard({ item, index }: { item: any, index: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Persistent Tag Pill - Always Viewed, Not Eaten */}
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
        <span className="inline-block px-6 md:px-8 py-2 md:py-3 rounded-full bg-white text-[#0a4b3d] text-[10px] md:text-sm font-black uppercase tracking-widest shadow-xl border border-black/5">
          {item.tag}
        </span>
      </div>
