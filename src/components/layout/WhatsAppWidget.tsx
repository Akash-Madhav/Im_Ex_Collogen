...
export default function WhatsAppWidget() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-20 transition-all group-hover:scale-150"></div>
      <div className="relative w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.3)] transform hover:scale-110 transition-transform duration-300">
        <svg 
          viewBox="0 0 24 24" 
          width="28" 
          height="28" 
